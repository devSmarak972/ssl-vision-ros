...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CMPattern__TeamDetectorSettings_t, stringdata0) + ofs \
...
void CMPattern::TeamDetectorSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TeamDetectorSettings *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (TeamDetectorSettings::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TeamDetectorSettings::teamInfoChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CMPattern::TeamDetectorSettings::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_CMPattern__TeamDetectorSettings.data,
    qt_meta_data_CMPattern__TeamDetectorSettings,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CMPattern::TeamDetectorSettings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CMPattern__TeamDetectorSettings.stringdata0))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CMPattern__TeamSelector_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TeamSelector *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TeamSelector::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TeamSelector::signalTeamDataChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CMPattern::TeamSelector::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_CMPattern__TeamSelector.data,
    qt_meta_data_CMPattern__TeamSelector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CMPattern__TeamSelector.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}
