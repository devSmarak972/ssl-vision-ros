...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PluginDVRWidget_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject PluginDVRWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_PluginDVRWidget.data,
    qt_meta_data_PluginDVRWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PluginDVRWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PluginDVRWidget.stringdata0))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PluginDVR_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
void PluginDVR::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PluginDVR *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject PluginDVR::staticMetaObject = { {
    &VisionPlugin::staticMetaObject,
    qt_meta_stringdata_PluginDVR.data,
    qt_meta_data_PluginDVR,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_PluginDVR.stringdata0))
        return static_cast<void*>(this);
