...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VisionPlugin_t, stringdata0) + ofs \
...
void VisionPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<VisionPlugin *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject VisionPlugin::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_VisionPlugin.data,
    qt_meta_data_VisionPlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *VisionPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VisionPlugin.stringdata0))
